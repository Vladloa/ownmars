...
export function Input({
  ...
  const inputClassName = cn(
    "h-11 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] text-foreground leading-11 outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72 sm:h-11 sm:leading-11 autofill:[-webkit-text-fill-color:var(--foreground)]",
    size === "sm" &&
      "h-9 px-[calc(--spacing(2.5)-1px)] leading-9 sm:h-9 sm:leading-9",
    size === "lg" && "h-11 leading-11 sm:h-11 sm:leading-11",
    props.type === "search" &&
